                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary btn-sm" href="updateproduct.php?productid=<?php echo $products->getproductid(); ?>"><span><i class="mdi mdi-border-color"></i></span></a>
                                                            <button class="btn btn-danger btn-sm" onclick="softDeleteProduct(<?php echo $products->getproductid(); ?>)"><i class="mdi mdi-backspace"></i></button>
                                                        </td>
    ...
    <script>
        function softDeleteProduct(productId) {
            if (confirm("Are you sure you want to move this product to trash?")) {
                const url = 'softdeleteproduct.php?productid=' + productId;
