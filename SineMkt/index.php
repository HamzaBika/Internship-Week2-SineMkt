						...
						<div class="col-sm-4">
							<div class="single-blog">
								<div class="single-blog-img">
									<img src="../admin/assets/images/blog/<?php echo $blogs->getblogimg(); ?>" alt="blog image">
									<div class="single-blog-img-overlay"></div>
								</div>
								<div class="single-blog-txt">
									<h2><a target="_blank" href="blog.php?Blog_Id= <?php echo $blogs->getblogid(); ?>"><?php echo $blogs->getblogtitle(); ?></a></h2>
									<h3>By <a target="_blank" href="blog.php?Blog_Id= <?php echo $blogs->getblogid(); ?>"> <?php echo $blogs->getblogauthor(); ?></a> / <?php echo $blogs->getdatecreation(); ?></h3>
								</div>
							</div>
						</div>
					<?php
